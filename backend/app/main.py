...
from .routers import cluster, evals, instances, jobs, models, nodes, playground, power, status
...
for r in (nodes, cluster, models, instances, status, playground, jobs, evals, power):
