...
for r in (nodes, cluster, models, instances, endpoints, status, playground, jobs, evals, power, logs, alerts, auth, usage, schedules, backup, storage, gateway, profiles, sessions_router):
